      ...
      <div className="bg-gray-800 rounded-2xl p-8 w-full max-w-md text-center border border-gray-700">
        ...
        <div className="space-y-4">
          <button
            ...
            className="w-full bg-white hover:bg-gray-100 text-gray-900 font-medium py-3 px-6 rounded-full flex items-center justify-center space-x-3 transition-colors shadow-lg"
          >
            <GoogleIcon />
